...
#property description "Trend envelopes - of averages - histo"
//------------------------------------------------------------------
...
int OnInit()
  {
   ...
   IndicatorSetString(INDICATOR_SHORTNAME,"Trend envelopes ("+(string)inpDeviation+")("+(string)inpSmtPeriod+" "+_avgNames[inpMaMethod]+" smoothed)");
